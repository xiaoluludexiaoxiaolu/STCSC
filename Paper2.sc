...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Nov 2024 04:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Nov 2024 04:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Nov 2024 04:00:00.000000000
        Stop		 1 Dec 2024 04:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Nov 2024 04:00:00.000000000
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            ...
            Style		 Access
            AGIViewer		 Yes
            Instance		 Satellite/JILIN_1_40961
            BEGIN InstanceList
                Instance		 Facility/Beijing_Station
            END InstanceList
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
        ...
        BEGIN Report
            ...
            WindowRectLeft		 226
            WindowRectTop		 125
            WindowRectRight		 1613
            WindowRectBottom		 617
        END Report
    END QuickReports
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 1 Aug 2023 04:00:00.000000000
                    Stop		 2 Aug 2023 04:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
    ...
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Nov 2024 04:00:00.000000000
                EndTime		 1 Dec 2024 04:00:00.000000000
                CurrentTime		 28 Nov 2024 09:43:00.529000000
                Mode		 Stop
                Direction		 Forward
                UpdateDelta		 10
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        ...
                        SecondaryBody		 Sun
                        CenterLatitude		 0
                        CenterLongitude		 -11.70731707317071
                        ...
                        BEGIN ZoomLocations
                            BEGIN ZoomLocation
                                CenterLat		 0
                                CenterLon		 -11.70731707317071
                                ZoomWidth		 360
                                ZoomHeight		 152.7815805849409
                            END ZoomLocation
                        END ZoomLocations
...
# order: kind:domain:country:catagory:subCatagory:specific:xtra ( -1 = * )
    ...
    BEGIN References
        ...
        END Instance
        Instance Facility/Beijing_Station
            Facility/Beijing_Station		
            Facility/Beijing_Station/Receiver/Receiver1		
        END Instance
        Instance Facility/Beijing_Station/Receiver/Receiver1
            Facility/Beijing_Station/Receiver/Receiver1		
        END Instance
        Instance Satellite/JILIN_1_40961
            Satellite/JILIN_1_40961		
            Satellite/JILIN_1_40961/Sensor/Sensor1		
        END Instance
        Instance Satellite/JILIN_1_40961/Sensor/Sensor1
            Satellite/JILIN_1_40961/Sensor/Sensor1		
            Satellite/JILIN_1_40961/Sensor/Sensor1/Transmitter/Transmitter1		
        END Instance
        Instance Satellite/JILIN_1_40961/Sensor/Sensor1/Transmitter/Transmitter1
            Satellite/JILIN_1_40961/Sensor/Sensor1/Transmitter/Transmitter1		
        END Instance
    END References
