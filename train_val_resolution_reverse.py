...
def main():
    ...
    save_path = "./trainval_unresolution73"

    image_path_base = "train_val_img_partiton_token/unresolution73"
        ...
        for i in img_list:
            ...
            with open(json_path, "r") as f:
                ...
                with torch.no_grad():
                    ...
                    sorted_index = torch.argsort(attn_dict, descending=False).tolist()
                    # print(sorted_index)
